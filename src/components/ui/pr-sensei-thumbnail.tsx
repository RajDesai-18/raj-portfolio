...
export function PrSenseiThumbnail() {
    ...
    const particlePercent =
        particleAt >= 0 ? (particleAt / (TOTAL_NODES - 1)) * 100 : 0;
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        "radial-gradient(circle, rgba(239,230,216,0.03) 1px, transparent 1px)",
                ...
                <div className="relative flex items-center justify-between">
                    ...
                    <div
                        ...
                        style={{
                            ...
                            backgroundColor: "var(--accent-raw)",
                            boxShadow:
                                "0 0 8px var(--accent-raw), 0 0 20px var(--accent-glow)",
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        animation: isProcessing
                                            ? "pr-node-pulse 0.8s ease-in-out infinite"
                                            : "none",
                                    ...
                                    opacity:
                                        line.type === "del"
                                            ...
                                            : line.type === "ctx"
                                                ...
                                                : 1,
                                    textDecoration:
                                        line.type === "del" ? "line-through" : "none",
            ...
            <div
                className="relative shrink-0 px-4 pb-3 pt-2 md:px-6 md:pb-4"
                style={{ zIndex: 1 }}
            >
                <div

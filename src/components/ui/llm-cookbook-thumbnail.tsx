...
const DOTS: EmbeddingDot[] = [
    ...
    // ── Fresh cluster ──
    { id: 15, x: 72, y: 48, size: 4, cluster: "fresh", label: "Citrus Fennel Salad", similarity: 0.91 },
    { id: 16, x: 82, y: 54, size: 4, cluster: "fresh", label: "Mango Avocado Bowl", similarity: 0.88 },
    ...
    // ── Dessert cluster ──
    { id: 20, x: 48, y: 72, size: 4, cluster: "dessert", label: "Molten Lava Cake", similarity: 0.94 },
    { id: 21, x: 58, y: 80, size: 4, cluster: "dessert", label: "Truffle Brownies", similarity: 0.90 },
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        "radial-gradient(circle, rgba(239,230,216,0.025) 1px, transparent 1px)",
            ...
            >
                <div
                    ...
                    style={{
                        ...
                        borderWidth: "1px",
                        borderStyle: "solid",
                        borderColor: isSweeping || sweepComplete
                            ? "var(--accent-raw)"

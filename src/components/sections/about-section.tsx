                    ...
                    <Container className="relative">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-[1fr_440px] gap-12 xl:gap-20 items-center">
                            ...
                            <div>
                                ...
                                >
                                    I&apos;m a product-minded full-stack engineer currently
                                    working towards my Master&apos;s in Computer Science at UT
                                    Dallas, graduating in May 2026, and seeking full-time
                                    opportunities. I like building software that is both{" "}
                                    <span style={{ color: "var(--accent-raw)", fontWeight: 600 }}>
                                        useful
                                    </span>{" "}
                                    and{" "}
                                    <span style={{ color: "var(--accent-raw)", fontWeight: 600 }}>
                                    ...
                                    , and I care deeply about purpose, behavior, and user
                                    experience.
                                </p>
                                ...
                                >
                                    I build polished interfaces, robust backend systems, and
                                    thoughtful AI-driven features. My strength is making every
                                    product{" "}
                                    <span style={{ color: "var(--accent-raw)", fontWeight: 600 }}>
                                        unified
                                    </span>{" "}

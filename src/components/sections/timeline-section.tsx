    ...
    const ctx = gsap.context(() => {
      if (isDesktop) {
        ...
        if (spineRef.current) {
          ...
          tl.to(spineRef.current, { scaleY: 1, duration: 0.8, ease: "none" }, 0.05);
        }
    ...
    <section ref={sectionRef} id={id} className="relative w-full overflow-hidden">
      <div ref={pinWrapRef} className="relative w-full">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
          <GhostText text={ghostText} align={ghostAlign} speed={0.4} offsetY="5%" />
        </div>
          ...
          <Container className="relative w-full">
            ...
            <div className="relative mt-6 lg:mt-10">
              ...
              <div
                ...
                style={{
                  width: "1.5px",
                  background: "linear-gradient(to bottom, var(--accent-raw), transparent)",
                  opacity: 0.3,
                }}
              />
              ...
              {entries.map((entry, i) => {
                ...
                return (
                  <div
                    ...
                    className={cn("relative", !isLast && "mb-10 lg:mb-[4.5rem]")}
                  >
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start">
                      ...
                      >
                        ...
                        <div
                          ...
                          className={cn("flex items-center gap-2 mb-3", isLeft && "lg:justify-end")}
                          style={{ opacity: 0 }}
                        >
                          {entry.isCurrent && (
                            <div
                          ...
                          <span
                            ...
                            style={{
                              color: entry.isCurrent ? "var(--accent-raw)" : "var(--text-muted)",
                            }}
                          >
                            {entry.dateLabel}
                          </span>
                      ...
                      <div
                        ...
                        className={cn(
                          ...
                          isLeft ? "lg:order-3 lg:pl-10" : "lg:order-1 lg:pr-10 lg:text-right"
                        )}
                        style={{ opacity: 0 }}
                      >
                        <span

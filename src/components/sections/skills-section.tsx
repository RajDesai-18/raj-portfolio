...
function calcPanelWidths(progress: number, count: number): number[] {
  ...
  if (progress >= 1 - exitZone) {
    return Array.from({ length: count }, (_, i) => (i === count - 1 ? expandedW : compressedW));
  }
...
export function SkillsSection() {
  ...
  const applyWidths = useCallback((widths: number[], activeIdx: number) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const expandRatio = Math.max(0, (widths[i] - 100 / count) / (52 - 100 / count));
  ...
  // ── Scroll-driven pin ──
  useEffect(() => {
    if (!sectionRef.current || !pinWrapRef.current || !accordionRef.current) return;
    ...
    <section ref={sectionRef} id="skills" className="relative w-full overflow-hidden">
      <div ref={pinWrapRef} className="relative w-full" style={{ height: "100vh" }}>
        ...
        <div className="absolute inset-0 flex flex-col" style={{ zIndex: 1 }}>
          ...
          <div className="hidden lg:block flex-1" style={{ padding: "0.75rem 64px 1.5rem" }}>
            <div
              ref={accordionRef}
              ...
              {SKILLS.map((skill, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderRight: i < SKILLS.length - 1 ? "1px solid var(--text)" : "none",
                  }}
                  role="button"
                  tabIndex={0}
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      padding: "clamp(1.25rem, 2.5vh, 2rem) 0 clamp(2.5rem, 5vh, 4rem)",
                    }}
                  >
                    ...
                    <div className="flex items-baseline gap-3">
                      ...
                      <h3
                        ...
                        style={{
                          ...
                          color: isActive ? "var(--accent-raw)" : "var(--text)",
